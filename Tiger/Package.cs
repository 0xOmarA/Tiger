...
namespace Tiger
{
    ...
    public class Package
    {
        ...
        public Tiger.Formats.Header header()
        {
            ...
            Logger.log($"Header not cached. Building header for {this.name}", LoggerLevels.HighVerbouse);
            ...
            Logger.log($"Package {name} has {header_holder.entry_table_size} entries at an offset of 0x{header_holder.entry_table_offset.ToString("X4")}", LoggerLevels.MediumVerbouse);
            return header_holder;
        }  
